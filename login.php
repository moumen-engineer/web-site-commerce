...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select) > 0){   // client existe dans la base de donnees 
      ...
      $_SESSION['user_id'] = $row['id'];   // pour le id de utilisateur dans le panier 
      header('location:homeclient.php');
   }else{
      $message[] = 'mot de passe ou email est incorrect, OK';
   }
...
<body>
   <center>
      ...
      ?>
      <br>
      <img src="Images/Logoblack2.png" alt="" width="170px">
      <br><br><br>
      <div class="form-container">
         <form action="" method="post">
            ...
            <p>avez-vous déjà un compte ? <a href="register.php">nouveau compte</a></p>
            <a href="homevisiteur.php"><h5>home</h5></a>
         </form>
      </div>
   </center>
</body>
