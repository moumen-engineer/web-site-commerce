...
<body>
    <header>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <div href="homevisiteur.php?" onclick="return confirm('vous devez etre connecté à votre compte');">Chausseur</div>
        <div href="homevisiteur.php?" onclick="return confirm('vous devez etre connecté à votre compte');">hommes</div>
        <div href="homevisiteur.php?" onclick="return confirm('vous devez etre connecté à votre compte');">Femmes</div>
        <div href="homevisiteur.php?" onclick="return confirm('vous devez etre connecté à votre compte');">Enfants</div>
        <div href="homevisiteur.php?" onclick="return confirm('vous devez etre connecté à votre compte');">Sports</div>
        <aside>
            <div>
                <a href="login.php"><img src="Images/mancompte.png" alt="Aller à la page de connexion" style="cursor: pointer;"></a>
            </div>
            <div>
                <img href="homevisiteur.php?" onclick="return confirm('il faut connecter pour remplie le panier');" src="Images/panierlogo.png">
            </div>
        </aside>
    </header>
    <section>
